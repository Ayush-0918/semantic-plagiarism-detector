...
def init_tracer_provider(exporter: Optional[SpanExporter] = None) -> TracerProvider:
...
def get_tracer(name: str = "semantic-plagiarism.detector") -> trace.Tracer:
...
def extract_traceparent(carrier: dict[str, str]) -> trace.Context:
